        ...
        <div>
            ...
            {words.length > initialWordLimit && (
                <div className="flex justify-center">
                    <button
                        className="mt-3 px-2 py-1 rounded-full bg-primary text-l w-22 text-center text-white-500 no-underline m-2 flex items-center" // Added 'flex items-center' class
